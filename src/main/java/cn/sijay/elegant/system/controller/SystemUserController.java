...
public class SystemUserController extends BaseController {
     ...
     */
    @PostMapping("/add")
    public Result<String> add(@RequestBody SystemUser entity) {
        return of(systemUserService.add(entity), "保存");
    }
     ...
     */
    @PostMapping("/update")
    public Result<String> update(@RequestBody SystemUser entity) {
        return of(systemUserService.update(entity), "更新");
    }
    ...
    public Result<String> importData(@RequestPart("file") MultipartFile file) throws Exception {
        return of(systemUserService.importData(ExcelUtil.importExcel(file.getInputStream(), SystemUser.class)), "导入");
    }
