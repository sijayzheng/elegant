...
public class SystemRoleController extends BaseController {
     ...
     */
    @PostMapping("/add")
    public Result<String> add(@RequestBody SystemRole entity) {
        return of(systemRoleService.add(entity), "保存");
    }
     ...
     */
    @PostMapping("/update")
    public Result<String> update(@RequestBody SystemRole entity) {
        return of(systemRoleService.update(entity), "更新");
    }
    ...
    public Result<String> importData(@RequestPart("file") MultipartFile file) throws Exception {
        return of(systemRoleService.importData(ExcelUtil.importExcel(file.getInputStream(), SystemRole.class)), "导入");
    }
