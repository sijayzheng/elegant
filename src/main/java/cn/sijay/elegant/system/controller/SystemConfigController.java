...
public class SystemConfigController extends BaseController {
     ...
     */
    @PostMapping("/add")
    public Result<String> add(@RequestBody SystemConfig entity) {
        return of(systemConfigService.add(entity), "保存");
    }
     ...
     */
    @PostMapping("/update")
    public Result<String> update(@RequestBody SystemConfig entity) {
        return of(systemConfigService.update(entity), "更新");
    }
    ...
    public Result<String> importData(@RequestPart("file") MultipartFile file) throws Exception {
        return of(systemConfigService.importData(ExcelUtil.importExcel(file.getInputStream(), SystemConfig.class)), "导入");
    }
