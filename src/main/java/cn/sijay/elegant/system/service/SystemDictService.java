...
import cn.sijay.elegant.system.mapper.SystemDictMapper;
...
public class SystemDictService extends ServiceImpl<SystemDictMapper, SystemDict> {
     ...
     * @return 是否新增成功
     */
    public boolean add(SystemDict entity) {
        validate(entity);
        return save(entity);
    }
     ...
     * @return 是否修改成功
     */
    public boolean update(SystemDict entity) {
        validate(entity);
     ...
     * @param list 导入的数据
     */
    public boolean importData(List<SystemDict> list) {
    ...
    private QueryWrapper buildQueryWrapper(SystemDict entity) {
        if (ObjectUtils.isEmpty(entity)) {
            return QueryWrapper.create();
        }
        return QueryWrapper.create()
                           .like(SystemDict::getCode, entity.getCode())
                           .like(SystemDict::getName, entity.getName())
                ;
    }
}
