    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermission="'${moduleName}:${businessName}:add'" icon="Plus" plain type="primary" @click="add">新增
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button :disabled="!ids.length" v-hasPermission="'${moduleName}:${businessName}:remove'" icon="Delete" plain type="danger"
                   @click="remove">删除
            </el-button>
          </el-col>
        </el-row>
        ...
        <el-table-column align="center" class-name="small-padding fixed-width" label="操作" width="150">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermission="'${moduleName}:${businessName}:edit'" icon="Edit" link type="primary"
                     @click="edit(scope.row)"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermission="'${moduleName}:${businessName}:remove'" icon="Delete" link type="primary"
...
<script name="${className}" setup>
  ...
  const pageList = async () => {
    loading.value = true
      ${businessName}Api.listTree(queryParams.value).then(res => {
